var app = (function() {
    ...
    var light_1_angle=Math.PI/4;
	var light_2_angle=Math.PI/4+Math.PI;
    ...
    var illumination = {
        ...
        light : [ {
            isOn : true,
            position : calculate_light_position(1),
            color : [ 1., 1., 1. ]
        },
        { 
            isOn : true ,
            position : calculate_light_position(2),
            color : [ 1. , 1. , 1. ]},
    ]
    };
    ...
    function calculate_light_position(light){
		var angle;
		var x;
		var z;
		var radius=8;
    ...
    function initEventHandler() {
        ...
        window.onkeydown = function(evt) {
            ...
            switch(c) {
                case('l'):
                case('L'):
                    var current_light_1_position=illumination.light[0].position;
                    light_1_angle=(light_1_angle+0.1)%(2*Math.PI);
                    light_2_angle=(light_2_angle+0.1)%(2*Math.PI);
                    
                    var light_1_position=calculate_light_position(1);
                    var light_2_position=calculate_light_position(2);
                    illumination.light[0].position=light_1_position;
                    illumination.light[1].position=light_2_position;
